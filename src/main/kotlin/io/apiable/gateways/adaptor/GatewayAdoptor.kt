...
import io.apiable.gateways.adaptor.models.domain.Api
import io.apiable.gateways.adaptor.models.domain.Plan
...
interface GatewayAdoptor {
    ...
    fun getDocumentation(conf: Conf, id:String, version:String, type: String, format: String = "application/json") : JsonObject
